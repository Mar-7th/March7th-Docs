import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as s,o as a,e as t}from"./app-BQ5_63dH.js";const p={},o=t(`<p>本页面介绍 MiHoMo API 的使用方式。</p><h2 id="mihomo-api-调用说明" tabindex="-1"><a class="header-anchor" href="#mihomo-api-调用说明"><span>MiHoMo API 调用说明</span></a></h2><h3 id="请求方式" tabindex="-1"><a class="header-anchor" href="#请求方式"><span>请求方式</span></a></h3><p>MiHoMo API 使用 HTTP GET 方式请求，相关参考：<a href="https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Methods/GET" target="_blank" rel="noopener noreferrer">HTTP GET</a>。</p><p>如果在网站或机器人项目中使用了 MiHoMo API，推荐在 User-Agent 中添加应用名称信息，以方便 API 服务调试使用。</p><p>当前 API 主站 Host: https://api.mihomo.me</p><p>图片资源仓库：https://github.com/Mar-7th/StarRailRes</p><p>Discord: <a href="https://discord.gg/SxCGCGSjbX" target="_blank" rel="noopener noreferrer"><img src="https://img.shields.io/badge/MiHoMo-blue?logo=discord&amp;logoColor=white" alt="discord" loading="lazy"></a></p><h3 id="mihomo-originapi" tabindex="-1"><a class="header-anchor" href="#mihomo-originapi"><span>MiHoMo OriginAPI</span></a></h3><p>MiHoMo OriginAPI 返回原始玩家信息。</p><p>终结点：<code>/sr_info/{uid}</code></p><p><strong>路径参数</strong></p><table><thead><tr><th>字段名</th><th>数据类型</th><th>说明</th></tr></thead><tbody><tr><td>uid</td><td>string</td><td>查询玩家 UID</td></tr></tbody></table><p><strong>响应数据</strong></p><p>见 <a href="#mihomo-originapi-%E8%BF%94%E5%9B%9E%E5%AD%97%E6%AE%B5">MiHoMo OriginAPI 返回字段</a></p><h3 id="mihomo-parsedapi" tabindex="-1"><a class="header-anchor" href="#mihomo-parsedapi"><span>MiHoMo ParsedAPI</span></a></h3><p>MiHoMo OriginAPI 返回原始玩家信息。</p><p>终结点：<code>/sr_info_parsed/{uid}</code></p><p><strong>路径参数</strong></p><table><thead><tr><th>字段名</th><th>数据类型</th><th>说明</th></tr></thead><tbody><tr><td>uid</td><td>string</td><td>查询玩家 UID</td></tr></tbody></table><p><strong>请求参数</strong></p><table><thead><tr><th>字段名</th><th>数据类型</th><th>默认值</th><th>说明</th></tr></thead><tbody><tr><td>lang</td><td>string</td><td>cn</td><td>语言</td></tr><tr><td>version</td><td>string</td><td>v2</td><td>API 版本</td></tr><tr><td>is_force_update</td><td>bool</td><td>false</td><td>不使用缓存数据</td></tr></tbody></table><p>支持语言列表：</p><table><thead><tr><th>代码</th><th>语言</th></tr></thead><tbody><tr><td>cn</td><td>简体中文</td></tr><tr><td>cht</td><td>繁體中文</td></tr><tr><td>de</td><td>Deutsch</td></tr><tr><td>en</td><td>English</td></tr><tr><td>es</td><td>Español</td></tr><tr><td>fr</td><td>Français</td></tr><tr><td>id</td><td>Bahasa Indonesia</td></tr><tr><td>jp</td><td>日本語</td></tr><tr><td>kr</td><td>한국어</td></tr><tr><td>pt</td><td>Português</td></tr><tr><td>ru</td><td>Русский</td></tr><tr><td>th</td><td>ภาษาไทย</td></tr><tr><td>vi</td><td>Tiếng Việt</td></tr></tbody></table><p><strong>响应数据</strong></p><p>见 <a href="#mihomo-parsedapi-%E8%BF%94%E5%9B%9E%E5%AD%97%E6%AE%B5">MiHoMo ParsedAPI 返回字段</a></p><h2 id="mihomo-api-字段说明" tabindex="-1"><a class="header-anchor" href="#mihomo-api-字段说明"><span>MiHoMo API 字段说明</span></a></h2><h3 id="mihomo-originapi-返回字段" tabindex="-1"><a class="header-anchor" href="#mihomo-originapi-返回字段"><span>MiHoMo OriginAPI 返回字段</span></a></h3><p>MiHoMo OriginAPI 返回值结构如下：</p><div class="language-json line-numbers-mode" data-ext="json" data-title="json"><pre class="language-json"><code><span class="token punctuation">{</span>
  ...
  <span class="token property">&quot;detailInfo&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    ...
    <span class="token property">&quot;recordInfo&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
      <span class="token comment">// 此字段已移除</span>
...
<span class="token keyword">class</span> <span class="token class-name">MihomoApiData</span><span class="token punctuation">(</span>BaseModel<span class="token punctuation">)</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="mihomo-parsedapi-返回字段" tabindex="-1"><a class="header-anchor" href="#mihomo-parsedapi-返回字段"><span>MiHoMo ParsedAPI 返回字段</span></a></h3><p>MiHoMo ParsedAPI 返回值结构如下：</p><div class="language-json line-numbers-mode" data-ext="json" data-title="json"><pre class="language-json"><code><span class="token punctuation">{</span>
  <span class="token property">&quot;player&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    ...
    <span class="token property">&quot;space_info&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
      <span class="token comment">// 新版本中已移除该字段</span>
      <span class="token comment">// &quot;memory_data&quot;: { &quot;level&quot;: 0, &quot;chaos_id&quot;: 0, &quot;chaos_level&quot;: 15 },</span>
...
<span class="token keyword">class</span> <span class="token class-name">MemoryInfo</span><span class="token punctuation">(</span>BaseModel<span class="token punctuation">)</span><span class="token punctuation">:</span>
    level<span class="token punctuation">:</span> <span class="token builtin">int</span> <span class="token operator">=</span> <span class="token number">0</span>
    chaos_id<span class="token punctuation">:</span> <span class="token builtin">int</span> <span class="token operator">=</span> <span class="token number">0</span>
    chaos_level<span class="token punctuation">:</span> <span class="token builtin">int</span> <span class="token operator">=</span> <span class="token number">0</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,37),e=[o];function l(i,c){return a(),s("div",null,e)}const k=n(p,[["render",l],["__file","mihomo_api.html.vue"]]),d=JSON.parse('{"path":"/zh/resource/mihomo_api.html","title":"MiHoMo API","lang":"zh-CN","frontmatter":{"title":"MiHoMo API","icon":"ph:link-simple-horizontal","order":5,"category":["资源"],"description":"本页面介绍 MiHoMo API 的使用方式。 MiHoMo API 调用说明 请求方式 MiHoMo API 使用 HTTP GET 方式请求，相关参考：HTTP GET。 如果在网站或机器人项目中使用了 MiHoMo API，推荐在 User-Agent 中添加应用名称信息，以方便 API 服务调试使用。 当前 API 主站 Host: https...","head":[["link",{"rel":"alternate","hreflang":"en-us","href":"https://march7th.xiaohei.moe/en/resource/mihomo_api.html"}],["meta",{"property":"og:url","content":"https://march7th.xiaohei.moe/zh/resource/mihomo_api.html"}],["meta",{"property":"og:site_name","content":"March7th 文档"}],["meta",{"property":"og:title","content":"MiHoMo API"}],["meta",{"property":"og:description","content":"本页面介绍 MiHoMo API 的使用方式。 MiHoMo API 调用说明 请求方式 MiHoMo API 使用 HTTP GET 方式请求，相关参考：HTTP GET。 如果在网站或机器人项目中使用了 MiHoMo API，推荐在 User-Agent 中添加应用名称信息，以方便 API 服务调试使用。 当前 API 主站 Host: https..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://img.shields.io/badge/MiHoMo-blue?logo=discord&logoColor=white"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:locale:alternate","content":"en-US"}],["meta",{"property":"og:updated_time","content":"2024-05-26T07:37:44.000Z"}],["meta",{"property":"article:author","content":"Mar-7th"}],["meta",{"property":"article:modified_time","content":"2024-05-26T07:37:44.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"MiHoMo API\\",\\"image\\":[\\"https://img.shields.io/badge/MiHoMo-blue?logo=discord&logoColor=white\\"],\\"dateModified\\":\\"2024-05-26T07:37:44.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Mar-7th\\",\\"url\\":\\"https://github.com/Mar-7th\\"}]}"]]},"headers":[{"level":2,"title":"MiHoMo API 调用说明","slug":"mihomo-api-调用说明","link":"#mihomo-api-调用说明","children":[{"level":3,"title":"请求方式","slug":"请求方式","link":"#请求方式","children":[]},{"level":3,"title":"MiHoMo OriginAPI","slug":"mihomo-originapi","link":"#mihomo-originapi","children":[]},{"level":3,"title":"MiHoMo ParsedAPI","slug":"mihomo-parsedapi","link":"#mihomo-parsedapi","children":[]}]},{"level":2,"title":"MiHoMo API 字段说明","slug":"mihomo-api-字段说明","link":"#mihomo-api-字段说明","children":[{"level":3,"title":"MiHoMo OriginAPI 返回字段","slug":"mihomo-originapi-返回字段","link":"#mihomo-originapi-返回字段","children":[]},{"level":3,"title":"MiHoMo ParsedAPI 返回字段","slug":"mihomo-parsedapi-返回字段","link":"#mihomo-parsedapi-返回字段","children":[]}]}],"git":{"createdTime":1683961498000,"updatedTime":1716709064000,"contributors":[{"name":"mobyw","email":"mobyw66@gmail.com","commits":11}]},"readingTime":{"minutes":6.37,"words":1910},"filePathRelative":"zh/resource/mihomo_api.md","localizedDate":"2023年5月13日","autoDesc":true}');export{k as comp,d as data};
